...
public class CESearchList extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
    	...
    	startActivity(new Intent("uk.ac.uclan.CECOURSEDETAILS"));//load the course with details
    ...
    //setup xml structure
  	private class SearchXMLTask extends AsyncTask<URL, Integer, String> {
  		...
  		private CESearchList activity;
  		
  		public SearchXMLTask(CESearchList activity) {
