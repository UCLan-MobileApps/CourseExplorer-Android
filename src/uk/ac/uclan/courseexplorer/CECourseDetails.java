...
public class CECourseDetails extends ExpandableListActivity {
    ...
    String credit;
		 ...
		 ExpandableListView courseDetails;
		    ...
		    public void onCreate(Bundle savedInstanceState)
		    {
		        ...
		        String[][] tempStringArray = {subject, qualifications, prerequisites, cabstract, description, careeroutcome, url, provider, aim, credits, presentation, assessmentstrategy, learningoutcome, indicativeresource, syllabus, leadsto};//expanded as needed
