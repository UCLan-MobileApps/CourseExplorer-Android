...
public class CEAdvancedSearch extends Activity {
    ...
    public void searchCourses() {
    	...
    	String choosenInstitution = "7e1643a5-457e-4b5a-8fa8-e7c755a03031";
	...
	private class ReadXMLTask extends AsyncTask<URL, Integer, String> {
		...
		private CEAdvancedSearch activity;
		
		public ReadXMLTask(CEAdvancedSearch activity) {
	...
	private class SearchXMLTask extends AsyncTask<URL, Integer, String> {
		...
		public SearchXMLTask(CEAdvancedSearch activity) {
			this.activity = activity;
			status = new ProgressDialog(activity);
		}
