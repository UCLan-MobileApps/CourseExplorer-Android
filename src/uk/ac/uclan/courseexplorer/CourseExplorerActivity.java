...
public class CourseExplorerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        advanced.setOnClickListener(new OnClickListener() 
        {
			...
			startActivity(new Intent("uk.ac.uclan.CEADVANCEDSEARCH"));
			}
		});
        ...
        information.setOnClickListener(new OnClickListener()
        {
			...
			startActivity(new Intent("uk.ac.uclan.CEINFORMATION"));
			}
        });
    } 
    ...
    public void searchCourses() {
  		...
  		String searchURL = ("http://coursedata.k-int.com/discover/?adv=true&q=" + keyword + "&provider=7e1643a5-457e-4b5a-8fa8-e7c755a03031&qualification=*&studyMode=*&distance=25&dunit=miles&order=distance&location=&max=100&format=xml");
      	...
      	URL url2;
  		try {
  			url2 = new URL("http://coursedata.k-int.com/discover/?adv=true&q=" + keyword + "&provider=7e1643a5-457e-4b5a-8fa8-e7c755a03031&qualification=*&studyMode=*&distance=25&dunit=miles&order=distance&location=&max=100&offset=0&format=xml");
    ...
    //setup xml structure
   	private class SearchXMLTask extends AsyncTask<URL, Integer, String> {
   		...
   		private CourseExplorerActivity activity;
   		
   		public SearchXMLTask(CourseExplorerActivity activity) {
   		...
   		protected void onPostExecute(String result) {
   			...
   			//Log.d("end", "end");		
   			startActivity(new Intent("uk.ac.uclan.CESEARCHLIST"));//load the list
			}
   		}
   	}
